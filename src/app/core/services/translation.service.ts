...
export class TranslationService {
  ...
  private translations: Record<SupportedLanguage, Translation> = {
   ...
   branches: {
    ...
    descriptionArPlaceholder: 'Enter branch description in Arabic',
    descriptionEn: 'Description (English)',
    descriptionEnPlaceholder: 'Enter branch description in English',
    address: 'Address',
    phone: 'Phone',
    email: 'Email',
    country: 'Country',
    workingHours: 'Working Hours',
    workingHoursPlaceholder: 'e.g., 08:00-18:00 Mon-Fri, 09:00-17:00 Sat-Sun',
    workingHoursHelp: 'Enter the working hours for this branch (e.g., "24/7" or "08:00 - 22:00")',
    assignedStaff: 'Assigned Staff',
    assignedStaffPlaceholder: 'Staff will be assigned automatically',
    assignedStaffHelp: 'Staff assignment is managed by the system',
    notes: 'Notes',
    notesPlaceholder: 'Additional notes about this branch',
    ...
    operatingHoursPlaceholder: 'Operating Hours',
    openTimePlaceholder: 'Opening Time',
    closeTimePlaceholder: 'Closing Time',
},
      ...
      vehicles: {
        ...
        brandArPlaceholder: 'Enter brand name in Arabic',
        brandEn: 'Brand (English)',
        brandEnPlaceholder: 'Enter brand name in English',
        modelAr: 'Model (Arabic)',
        modelArPlaceholder: 'Enter model name in Arabic',
        modelEn: 'Model (English)',
        modelEnPlaceholder: 'Enter model name in English',
        year: 'Year',
        yearPlaceholder: 'e.g., 2023',
        colorAr: 'Color (Arabic)',
        colorArPlaceholder: 'Enter color in Arabic',
        colorEn: 'Color (English)',
        colorEnPlaceholder: 'Enter color in English',
        plateNumber: 'License Plate',
        plateNumberPlaceholder: 'e.g., DXB-12345',
        seatingCapacity: 'Seating Capacity',
        seatingCapacityPlaceholder: 'Number of seats',
        numberOfDoors: 'Number of Doors',
        numberOfDoorsPlaceholder: 'Number of doors',
        maxSpeed: 'Max Speed',
        maxSpeedPlaceholder: 'Maximum speed in km/h',
        engine: 'Engine',
        enginePlaceholder: 'Engine specifications',
        transmissionType: 'Transmission',
        fuelType: 'Fuel Type',
        locationCategories: 'Location & Categories',
        locationCategoriesDesc: 'Assign vehicle to branch and category',
        branch: 'Branch',
        branchPlaceholder: 'Select branch',
        additionalInformation: 'Additional Information',
        additionalInformationDesc: 'Extra features and notes',
        descriptionAr: 'Description (Arabic)',
    ...
    ar: {
      ...
      branches: {
        ...
        descriptionArPlaceholder: 'أدخل وصف الفرع بالعربية',
        descriptionEn: 'الوصف (إنجليزي)',
        descriptionEnPlaceholder: 'أدخل وصف الفرع بالإنجليزية',
        address: 'العنوان',
        phone: 'الهاتف',
        email: 'البريد الإلكتروني',
        country: 'البلد',
        workingHours: 'ساعات العمل',
        workingHoursPlaceholder: 'مثال: 08:00-18:00 الاثنين-الجمعة، 09:00-17:00 السبت-الأحد',
        workingHoursHelp: 'أدخل ساعات العمل لهذا الفرع (مثال: "24/7" أو "08:00 - 22:00")',
        assignedStaff: 'الموظفون المعينون',
        assignedStaffPlaceholder: 'سيتم تعيين الموظفين تلقائياً',
        assignedStaffHelp: 'تعيين الموظفين يتم إدارته من قبل النظام',
        notes: 'ملاحظات',
        notesPlaceholder: 'ملاحظات إضافية حول هذا الفرع',
        ...
        operatingHoursPlaceholder: 'ساعات العمل',
        openTimePlaceholder: 'وقت الفتح',
        closeTimePlaceholder: 'وقت الإغلاق',
       },
      // إدارة المركبات
      vehicles: {
        ...
        brandArPlaceholder: 'أدخل اسم الماركة بالعربية',
        brandEn: 'الماركة (إنجليزي)',
        brandEnPlaceholder: 'أدخل اسم الماركة بالإنجليزية',
        modelAr: 'الموديل (عربي)',
        modelArPlaceholder: 'أدخل اسم الموديل بالعربية',
        modelEn: 'الموديل (إنجليزي)',
        modelEnPlaceholder: 'أدخل اسم الموديل بالإنجليزية',
        year: 'السنة',
        yearPlaceholder: 'مثل: 2023',
        colorAr: 'اللون (عربي)',
        colorArPlaceholder: 'أدخل اللون بالعربية',
        colorEn: 'اللون (إنجليزي)',
        colorEnPlaceholder: 'أدخل اللون بالإنجليزية',
        plateNumber: 'رقم اللوحة',
        plateNumberPlaceholder: 'مثل: DXB-12345',
        seatingCapacity: 'عدد المقاعد',
        seatingCapacityPlaceholder: 'عدد المقاعد',
        numberOfDoors: 'عدد الأبواب',
        numberOfDoorsPlaceholder: 'عدد الأبواب',
        maxSpeed: 'السرعة القصوى',
        maxSpeedPlaceholder: 'السرعة القصوى بالكيلومتر/ساعة',
        engine: 'المحرك',
        enginePlaceholder: 'مواصفات المحرك',
        transmissionType: 'ناقل الحركة',
        fuelType: 'نوع الوقود',
        locationCategories: 'الموقع والفئات',
        locationCategoriesDesc: 'تعيين المركبة للفرع والفئة',
        branch: 'الفرع',
        branchPlaceholder: 'اختر الفرع',
        additionalInformation: 'معلومات إضافية',
        additionalInformationDesc: 'ميزات إضافية وملاحظات',
        descriptionAr: 'الوصف (عربي)',
        descriptionArPlaceholder: 'أدخل الوصف بالعربية',
        descriptionEn: 'الوصف (إنجليزي)',
        descriptionEnPlaceholder: 'أدخل الوصف بالإنجليزية',
        mileage: 'المسافة المقطوعة',
        mileagePlaceholder: 'المسافة المقطوعة الحالية بالكيلومتر',
        features: 'الميزات',
  ...
  // Debug method to check if translations are loaded
