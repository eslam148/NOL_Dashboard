  ...
  template: `
    <div class="advertisement-detail-container">
      ...
      <div class="detail-placeholder">
        ...
        <h3>{{ 'advertisements.detailComingSoon' | translate }}</h3>
        <p>{{ 'advertisements.detailComingSoonDesc' | translate }}</p>
        <a routerLink="/car-rental/advertisements" class="btn btn-primary">
          <i class="bi bi-arrow-left"></i>
          {{ 'common.back' | translate }}
        </a>
      </div>
